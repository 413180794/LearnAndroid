...
import static com.example.learnandroid.learnrecyclerview.RecyclerViewFragmentKt.dip2Px;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public static ViewHolder get(Context context, View convertView, ViewGroup parent, int layoutId) {
        if (convertView == null) {
            ...
            ViewGroup.LayoutParams layoutParams =  holder2.getLayoutParams();
            layoutParams.height = (int) dip2Px(context, (int) (Math.random() * 80 + 40));
